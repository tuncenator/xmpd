...
>
> Last updated by: Checkpoint 5 -- Phase 6 xmpctl history-backfill (2026-05-13)
...
| `tests/test_xmpd_history.py` | 3 shell smoke tests for `bin/xmpd-history`. | fzf stubs extract and verify binding args. Tests: initial reload command, ctrl-t toggle via XMPD_HISTORY_MODE_FILE, clean exit on empty input. |
