"""Tests for xmpd.notify module."""

from unittest.mock import patch

import pytest

from xmpd import notify
...
class TestSendNotification:
    ...
    @patch("xmpd.notify.subprocess.run")
    ...
    @patch("xmpd.notify.subprocess.run", side_effect=FileNotFoundError)
    ...
    @patch("xmpd.notify.subprocess.run", side_effect=Exception("unexpected"))
